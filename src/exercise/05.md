...
State Reducer tradeoff:
* Increase flexibility at the cost of a wider API surface area, making API evolution harder.

On Credit 1, would it be better to always call toggleReducer and change only the bit we want? For example, instead of: 
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=05%3A%20State%20Reducer&em=arturop%40nulogy.com).
